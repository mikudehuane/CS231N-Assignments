...
class CaptioningRNN(object):
    ...
    def loss(self, features, captions):
        ...
        vocab_in, cache_embed = word_embedding_forward(captions_in, W_embed)
        if self.cell_type == 'rnn':
            hidden_states, cache_rnn = rnn_forward(vocab_in, h0, Wx, Wh, b)    # N*T*H
        if self.cell_type == 'lstm':
            hidden_states, cache_lstm = lstm_forward(vocab_in, h0, Wx, Wh, b)
